...
public class FileUtils {
    private static final String MAIN_DIR_NAME = "/Download";
    private static final String BASE_VIDEO = "/Webrtc_Recorder/";
    ...
    public boolean requestSwapFile(boolean force) {
        ...
        String fileName = PrefSingleton.getInstance().getString("MediaMuxer");
