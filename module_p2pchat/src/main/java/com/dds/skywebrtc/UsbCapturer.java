...
public class UsbCapturer implements VideoCapturer, USBMonitor.OnDeviceConnectListener {
    ...
    public UsbCapturer(Context context) {
    ...
    private void startPreview() {
        ...
        try {
            ...
            try {
                ...
                camera.setPreviewSize(UVCCamera.DEFAULT_PREVIEW_WIDTH, UVCCamera.DEFAULT_PREVIEW_HEIGHT, 1, mFps, UVCCamera.DEFAULT_PREVIEW_MODE, 1.0f);
            } catch (Exception e1) {
                camera.destroy();
                camera = null;
            }
